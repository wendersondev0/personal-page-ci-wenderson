...
<head>
	...
	<title>Site pessoal - wenderson</title>
	<!-- Bootstrap core CSS -->
	...
	<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				...
				<a class="navbar-brand page-scroll" href="#page-top"><img src="<?= base_url("public/images/logo.jpg") ?>" alt="Lattes theme logo"></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a class="page-scroll" href="<?= base_url() ?>#project">Projetos</a>
					</li>
					<li>
						<a class="page-scroll" href="<?= base_url() ?>#certificate">Certificados</a>
					</li>
					<li>
						<a class="page-scroll" href="<?= base_url() ?>#contact">Sobre</a>
					</li>
					<li>
